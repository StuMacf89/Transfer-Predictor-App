...
if page == 'Transfer Performance Estimator': 
    ...
    st.markdown('**Overiview** This application predicts if a player will achieve the same performance or better follwoing a club transfer into another league/ club')
    ...
    selected_position = st.sidebar.selectbox("Choose a Position(s)", positions)
