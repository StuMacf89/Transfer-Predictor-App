...
if page == 'Transfer Performance Estimator': 
    ...
    df_tech['new_performance_club_league_interaction'] = df_tech['new_club_performance']/df_tech['new_club_strength_relative_to_league']
    df_tech['club_league_interaction'] = df_tech['club_strength_difference'] * df_tech['league_strength_difference']

    scaler = StandardScaler()
    df_tech[['club_strength_difference', 'league_strength_difference', 'performance_league_interaction',
        'club_league_interaction', 'new_club_strength_relative_to_league', 'previous_club_strength_relative_to_league','previous_performance_club_league_interaction']] = scaler.fit_transform(
        df_tech[['club_strength_difference', 'league_strength_difference', 'performance_league_interaction',
            'club_league_interaction', 'new_club_strength_relative_to_league', 'previous_club_strength_relative_to_league','previous_performance_club_league_interaction']]
    )
    #Log Transformation
    df_tech['new_club_strength_relative_to_league'] = np.log1p(df_tech['new_club_strength_relative_to_league'] - df_tech['new_club_strength_relative_to_league'].min() + 1)
    df_tech['previous_club_strength_relative_to_league'] = np.log1p(df_tech['previous_club_strength_relative_to_league'] - df_tech['previous_club_strength_relative_to_league'].min() + 1)
    df_tech['new_club_strength_relative_to_league'] = np.log1p(df_tech['new_club_strength_relative_to_league'])
    df_tech['previous_club_strength_relative_to_league'] = np.log1p(df_tech['previous_club_strength_relative_to_league'])
    ...
    input_features = player_data[['Minutes played', 
                                    'market_price_log','Age','performance_league_interaction','previous_performance_club_league_interaction'
                                    'previous_club_strength_relative_to_league','new_club_strength_relative_to_league']].values
    # Append new features
    model_inputs = np.append(input_features, [player_data['club_strength_difference'],player_data['club_league_interaction']]).reshape(1, -1)
