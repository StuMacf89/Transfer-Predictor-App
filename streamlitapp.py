...
if page == 'Transfer Performance Estimator': 
    # Load data
    df_tech = pd.read_csv("StreamLit Dataset.csv")
    df_league_market_values = pd.read_csv("StreamLit League Values.csv")
    df_club_market_values = pd.read_csv("StreamLit Club Values Dataset.csv")
