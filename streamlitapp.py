...
if page == 'Transfer Performance Estimator': 
    ...
    df_tech['market_price_log'] = np.log1p(df_tech['Market value']) 
    ...
    player_data = df_tech[df_tech['Player'] == selected_player]
    input_features = player_data[['Minutes played','market_price_log','Age','performance_league_interaction','previous_performance_club_league_interaction'
